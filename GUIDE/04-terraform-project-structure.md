...
[← Previous: Responsibility Split](03-responsibility-split-terraform-cicd.md) · [Index](README.md) · [Next: Terraform Code Walkthrough →](05-terraform-code-walkthrough.md)
